...
var check = function (website) {
    ...
    var tile1 = website.$('meta[name*="square70x70logo"]'),
        tile2 = website.$('meta[name*="square150x150logo"]'),
        tile3 = website.$('meta[name*="wide310x150logo"]'),
        tile4 = website.$('meta[name*="square310x310logo"]'),
        test = {
            testName:"pinned",
            passed:false,
            data: {
