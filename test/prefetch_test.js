...
module.exports['Prefetch'] = {
    'No Prefetch': checkPage('1.html', {
        passed: false,
        data: {
            // iOS: true
        }}),
    'Prefetch Link PNG image': checkPage('2.html', {
        passed: true,
        data: {
            // iOS: true
        }}),
    'Prefetch Meta PNG image': checkPage('3.html', {
        passed: true,
        data: {
            // iOS: true
        }}),
    'Next Link PNG image': checkPage('4.html', {
        passed: true,
        data: {
            // iOS: true
        }}),
    'Prev Link PNG image': checkPage('5.html', {
        passed: true,
        data: {
            // iOS: true
        }}),
    'DNS-Prefetch Link PNG image': checkPage('6.html', {
        passed: true,
        data: {
            // iOS: true
        }}),
    'Prerender Link HTML document': checkPage('7.html', {
        passed: true,
        data: {
            // iOS: true
        }})
